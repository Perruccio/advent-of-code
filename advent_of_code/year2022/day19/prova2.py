#!/usr/bin/env python3
from advent_of_code.lib import parse as parse
...
def main():
    ...
    def search(blueprint, time=24):
        ...
        while q:
            ...
            if (robs and obs < max_obs_needed) or (rclay and clay < max_clay_needed) or ore < max_ore_needed:
                q.appendleft((time, newore, newclay, newobs, newgeo, rore, rclay, robs, rgeo, can_build))
    ...
    for line in parse.as_lines(aoc.read_input(2022, 19, "input.txt")):
