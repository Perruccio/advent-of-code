...
def get_input(file):
    ...
    return aoc.parse.map_by_line(raw, func=aoc.parse.get_ints)
...
def part1(data, min_coord=200000000000000, max_coord=400000000000000):
    ...
    for i, (x1, y1, z1, vx1, vy1, vz1) in enumerate(data):
        ...
        for x2, y2, z2, vx2, vy2, vz2 in data[i+1:]:
            ...
            if aoc.math.sign(x_inters - x1) == aoc.math.sign(vx1) and aoc.math.sign(x_inters - x2) == aoc.math.sign(vx2):
                res += 1
    return res
